...
#define _OutResi										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float3, _OutResi)
...
#define _AAS											UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _AAS)
...
#define _NoisTexInten									UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _NoisTexInten)
#define _StraWidt										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _StraWidt)
#define _NoiTexAffStraWidt								UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _NoiTexAffStraWidt)
#define _ShifAnis										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _ShifAnis)
...
#define _LLI_Min										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _LLI_Min)
#define _LLI_Max										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _LLI_Max)
...
#define _RimLigPosi										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float3, _RimLigPosi)
...
#define _ObjePosiZCS                                    UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _ObjePosiZCS)
