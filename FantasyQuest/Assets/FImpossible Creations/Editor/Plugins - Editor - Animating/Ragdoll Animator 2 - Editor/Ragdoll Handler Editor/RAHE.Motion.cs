...
namespace FIMSpace.FProceduralAnimation
{
    public static partial class RagdollHandlerEditor
    {
        ...
        private static void Motion_Main(SerializedProperty ragdollHandlerProp, RagdollHandler handler)
        {
            ...
            // AnchorUpdateMode start
            EditorGUIUtility.labelWidth = EditorGUIUtility.currentViewWidth < 450 ? 1 : 42;
            var spMode = ragdollHandlerProp.FindPropertyRelative( "AnchorUpdateMode" ); GUILayout.Space( 4 );
            EditorGUILayout.PropertyField( spMode, new GUIContent( "Mode:", spMode.tooltip ), GUILayout.MaxWidth( EditorGUIUtility.currentViewWidth < 390 ? 40 : ( EditorGUIUtility.currentViewWidth < 450 ? 70 : 110 ) ) );
            EditorGUIUtility.labelWidth = 0;
            // AnchorUpdateMode end
