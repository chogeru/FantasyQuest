...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public class RagdollChainBone
    {
        ...
        /// <summary>
        /// </summary>
        /// <param name="useAcceleration"> Only in unity 6 or newer, joint's drive mode </param>
        public void SetJointMatchingParameters( float spring, float dampingValue, bool useAcceleration = false )
        {
            if( Joint == null ) return;
        ...
        /// </summary>
        /// <param name="useAcceleration"> Only in unity 6 or newer, joint's drive mode </param>
        public void SetJointMatchingParametersPosition( float spring, float dampingValue, bool useAcceleration = false )
        {
        ...
        #region Extra Utility Variables

        /// <summary> Dedicated for custom usage -> modifying motion influence effect: RagdollHandler.MotionInfluence * Bone.MotionInfluenceMultiplier </summary>
        public float MotionInfluenceMultiplier = 1f;
