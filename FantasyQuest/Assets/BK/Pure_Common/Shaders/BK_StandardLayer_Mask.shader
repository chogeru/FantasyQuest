...
Shader "BK/Standard Layered Masked"
{
	Properties
	{
		...
		[Space(10)][Header(Detail Maps)][Space(10)]_LayerAlbedo("Albedo", 2D) = "white" {}
		...
		[Space(10)][Header(Layer Maps)][Space(10)][KeywordEnum(TopDown,VertexColor,Mask)] _LayerMode("Layer Mode", Float) = 0
		[KeywordEnum(R,G,B,A)] _VertexColorChannel("Vertex Color Channel", Float) = 2
		[Space(10)]_2ndColor("Color", Color) = (1,1,1,1)
		...
		[Space(10)]_BlendPower("Main Normal Blend", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		#pragma target 5.0
		#pragma shader_feature_local _LAYERMODE_TOPDOWN _LAYERMODE_VERTEXCOLOR _LAYERMODE_MASK
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 triplanar150 = TriplanarSampling150( _LayerNormalMap, ase_positionWS, ase_normalWS, 1.0, LayerUVs147, _SecondNormalPower, 0 );
			...
			float3 triplanar63 = TriplanarSampling63( _DetailNormalMap, ase_positionWS, ase_normalWS, 1.0, DetailUVs48, _2ndNormalPower, 0 );
			...
			#if defined( _LAYERMODE_TOPDOWN )
				float staticSwitch189 = (WorldNormalVector( i , tanTriplanarNormal63 )).y;
			#elif defined( _LAYERMODE_VERTEXCOLOR )
				float staticSwitch189 = ( pow( clampResult105 , ( 1.0 - _LayerPower ) ) * clampResult105 );
			#elif defined( _LAYERMODE_MASK )
				float staticSwitch189 = tex2DNode7.b;
			#else
				float staticSwitch189 = (WorldNormalVector( i , tanTriplanarNormal63 )).y;
			#endif
			float saferPower24 = abs( saturate( ( staticSwitch189 + _LayerPower ) ) );
			...
			float4 triplanar148 = TriplanarSampling148( _LayerAlbedo, ase_positionWS, ase_normalWS, 1.0, LayerUVs147, 1.0, 0 );
			float4 triplanar60 = TriplanarSampling60( _DetailAlbedo, ase_positionWS, ase_normalWS, 1.0, DetailUVs48, 1.0, 0 );
			...
			float4 triplanar152 = TriplanarSampling152( _LayerMetallicGlossMap, ase_positionWS, ase_normalWS, 1.0, LayerUVs147, 1.0, 0 );
			float4 triplanar65 = TriplanarSampling65( _DetailMetallicGlossMap, ase_positionWS, ase_normalWS, 1.0, DetailUVs48, 1.0, 0 );
...
/*ASEBEGIN
Version=19800
Node;AmplifyShaderEditor.CommentaryNode;115;-4224,384;Inherit;False;3710.179;639.6451;Mask for Layer (Moss, Snow...);21;179;85;24;163;17;25;16;93;14;72;105;73;22;112;113;109;110;162;34;189;191;Layer Mask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-3904,800;Inherit;False;Property;_LayerPosition;Layer Position;23;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-2848,-2112;Inherit;False;Property;_Tiling;Tiling;20;0;Create;True;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-3680,896;Inherit;False;Property;_LayerContrast;Layer Contrast;24;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;191;-3456,880;Inherit;False;True;False;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-3328,480;Float;False;Property;_LayerPower;Layer Power;21;0;Create;True;0;0;0;False;1;Space(10);False;0.5;0.288;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;73;-3040,432;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-3968,-192;Inherit;False;Property;_2ndNormalPower;Normal Power;18;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;105;-3200,784;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;52;-3968,-64;Inherit;False;48;DetailUVs;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;64;-4192,-288;Inherit;True;Property;_DetailNormalMap;Normal;17;0;Create;False;0;0;0;False;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PowerNode;72;-2848,592;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;93;-2592,752;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;14;-2400,560;Inherit;True;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ColorNode;11;-3456,-1152;Inherit;False;Property;_2ndColor;Color;15;0;Create;False;0;0;0;False;1;Space(10);False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.WireNode;180;-2960,272;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;189;-2080,720;Inherit;False;Property;_LayerMode;Layer Mode;13;0;Create;True;0;0;0;False;3;Space(10);Header(Layer Maps);Space(10);False;0;0;0;True;;KeywordEnum;3;TopDown;VertexColor;Mask;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;16;-1728,448;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-1728,704;Float;False;Property;_LayerThreshold;Layer Threshold;22;0;Create;True;0;0;0;False;0;False;50;50;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;17;-1504,448;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;24;-1280,448;Inherit;False;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;179;-1024,448;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;149;-4160,-1552;Inherit;True;Property;_LayerAlbedo;Albedo;8;0;Create;False;0;0;0;False;3;Space(10);Header(Detail Maps);Space(10);False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RegisterLocalVarNode;85;-768,448;Inherit;False;BlendAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3;-3584,-704;Inherit;True;Property;_BumpMap;Normal;2;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;1;-3840,-1745;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TexturePropertyNode;66;-4161,1792;Inherit;True;Property;_DetailMetallicGlossMap;Metallic (R) Occlusion (G) Smoothness (A);19;0;Create;False;0;0;0;False;0;False;None;None;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.GetLocalVarNode;50;-4000,2016;Inherit;False;48;DetailUVs;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;81;-2944,-320;Inherit;False;Constant;_Color0;Color 0;22;0;Create;True;0;0;0;False;0;False;0.01176471,0,1,1;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TexturePropertyNode;61;-4160,-1248;Inherit;True;Property;_DetailAlbedo;Albedo;16;0;Create;False;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.GetLocalVarNode;86;-2944,-96;Inherit;False;85;BlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2;-3456,-1872;Inherit;False;Property;_Color;Main Color;0;0;Create;False;0;0;0;False;2;Header(Mesh Maps);Space(10);False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.GetLocalVarNode;87;-2944,-512;Inherit;False;85;BlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;78;-2704,-256;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;90;-3072,1984;Inherit;False;85;BlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;88;-3168,-1360;Inherit;False;85;BlendAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;13;-2432,-640;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;30;-2816,1216;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;186;-2144,-288;Inherit;False;Property;_BlendPower;Main Normal Blend;25;0;Create;False;0;0;0;False;1;Space(10);False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;26;-2944,-1536;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-512,-640;Float;False;True;-1;7;;0;0;Standard;BK/Standard Layered Masked;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;191;0;112;0
WireConnection;73;0;22;0
WireConnection;105;0;191;0
...
WireConnection;189;1;14;2
WireConnection;189;0;93;0
WireConnection;189;2;7;3
WireConnection;16;0;189;0
...
ASEEND*/
//CHKSM=E2E59305B1916242E6DF22D7A17D71F94ACD6014